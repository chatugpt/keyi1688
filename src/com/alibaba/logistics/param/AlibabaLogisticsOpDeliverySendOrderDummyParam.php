...
include_once ('AlibabaLogisticsOpDeliverySendOrderDummyParam/AlibabaLogisticsOpSendGood.class.php');
include_once ('AlibabaLogisticsOpDeliverySendOrderDummyParam/AlibabaLogisticsOpReceiveContacter.class.php');
