...
include_once ('AlibabaLogisticsOpDeliverySendOrderOfflineParam/AlibabaLogisticsOpSendGood.class.php');
include_once ('AlibabaLogisticsOpDeliverySendOrderOfflineParam/AlibabaLogisticsOpReceiveContacter.class.php');
