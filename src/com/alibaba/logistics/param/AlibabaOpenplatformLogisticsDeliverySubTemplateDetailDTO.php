...
include_once ('AlibabaLogisticsMyFreightTemplateListGetParam/AlibabaOpenplatformLogisticsDeliverySubTemplateDTO.class.php');
include_once ('AlibabaLogisticsMyFreightTemplateListGetParam/AlibabaOpenplatformLogisticsDeliveryRateDetailDTO.class.php');
