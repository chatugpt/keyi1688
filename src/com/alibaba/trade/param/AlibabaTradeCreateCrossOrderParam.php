...
include_once ('AlibabaTradeCreateCrossOrderParam/AlibabaTradeFastAddress.class.php');
include_once ('AlibabaTradeCreateCrossOrderParam/AlibabaTradeFastCargo.class.php');
include_once ('AlibabaTradeCreateCrossOrderParam/AlibabaTradeFastInvoice.class.php');
...
class AlibabaTradeCreateCrossOrderParam {
    ...
    * @return 是否匿名下单
    */
        public function getAnonymousBuyer() {
        $tempResult = $this->sdkStdResult["anonymousBuyer"];
        return $tempResult;
    }
    
    /**
     * 设置是否匿名下单     
     * @param Boolean $anonymousBuyer     
     * 参数示例：<pre> </pre>     
     * 此参数必填     */
    public function setAnonymousBuyer( $anonymousBuyer) {
        $this->sdkStdResult["anonymousBuyer"] = $anonymousBuyer;
    }
