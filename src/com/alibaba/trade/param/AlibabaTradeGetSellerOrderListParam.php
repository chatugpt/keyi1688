...
服务类的交易流程(50080)
    ...
    * @return 是否查找投诉中的地拟改单
    */
    public function getTousuStatus()
    {
        $tempResult = $this->sdkStdResult["tousuStatus"];
        return $tempResult;
    }
    
    /**
     * 设置是否查找投诉中的地拟改单
     * @param Boolean $tousuStatus
     * 参数示例：<pre>false</pre>
     * 此参数必填     */
    public function setTousuStatus($tousuStatus)
    {
        $this->sdkStdResult["tousuStatus"] = $tousuStatus;
    }
    ...
    */
    public function getNeedCheckSend()
    {
        $tempResult = $this->sdkStdResult["needCheckSend"];
        return $tempResult;
    }
    
    /**
     * 设置是否需要返回发货校验信息，对于打单发货场景必须要填，非常重要
     * @param Boolean $needCheckSend
     * 参数示例：<pre>true</pre>
     * 此参数必填     */
    public function setNeedCheckSend($needCheckSend)
    {
        $this->sdkStdResult["needCheckSend"] = $needCheckSend;
    }
