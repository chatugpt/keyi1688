...
include_once ('AlibabaCreateOrderPreviewParam/AlibabaCreateOrderPreviewResultCargoModel.class.php');
include_once ('AlibabaCreateOrderPreviewParam/AlibabaTradePromotionModel.class.php');
include_once ('AlibabaCreateOrderPreviewParam/TradeModelExtensionList.class.php');
