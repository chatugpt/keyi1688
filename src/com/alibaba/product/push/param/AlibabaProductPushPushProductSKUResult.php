...
include_once ('AlibabaProductPushSyncPushProductResultParam/AlibabaProductPushSimpleItemDesc.class.php');
include_once ('AlibabaProductPushSyncPushProductResultParam/AlibabaProductPushAttributeRelationMapping.class.php');
