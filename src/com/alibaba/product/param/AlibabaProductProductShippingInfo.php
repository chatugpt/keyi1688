...
include_once ('AlibabaCrossProductInfoParam/AlibabaProductFreightTemplate.class.php');
include_once ('AlibabaCrossProductInfoParam/ComAlibabaOceanOpenplatformBizTradeResultProductAddressCode.class.php');
